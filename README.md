...
Procedure with all steps involved in setting up the website are provided in a document "DigitalFIRE-WikiStyle_ProjectSite_GitHub_v1.docx" present in this repository for reference.
...
[WikiSET](https://asiamina.github.io/DigitalFIRE-WikiStyle/) is a portal, called Wiki for Security Training and Education, that lists useful materials and tutorials for teaching and learning digital forensics.
